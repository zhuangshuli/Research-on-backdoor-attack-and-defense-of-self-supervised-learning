...
def get_args_parser():
    ...
    parser.add_argument('--blended_per', type=float, default=None)
...
def main(args):
    ...
    dataset_train,dataset_val,trigger = build_dataset(args=args)
    ...
    with open(log_path, 'w') as logfile:
        ...
        dic_l = {"train_lr": 9.974874371859296e-05, "train_loss": 4.96772102614743, "test_loss": 4.100756072998047, "test_acc1": 13.29, "test_acc5": 35.39, "test_triger_loss": 3.6984371662139894, "test_triger_acc1": 33.427135700628384, "test_triger_acc5": 54.91457284361873, "epoch": 0, "n_parameters": 85408712}
